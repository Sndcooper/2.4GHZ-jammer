/*
 * Educational placeholder for ESP32 + RF24 experiments.
 * This project is intended for lawful, controlled RF lab use only.
 * Do NOT use for real-world interference; follow local laws and safety rules.
 */
#include <Arduino.h>
